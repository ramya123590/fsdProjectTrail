...
import com.example.demo.SpringEntityDesignApplication;
...
@ContextConfiguration(classes = SpringEntityDesignApplication.class)
@SpringBootTest
...
public class EnquiryControllerTest {
	...
	org.slf4j.Logger log=LoggerFactory.getLogger(EnquiryControllerTest.class);
	@Autowired
	...
	@Test
	public void postEnquiry() throws Exception {
		mockMvc.perform(MockMvcRequestBuilders.get("/api/enquirys").accept(MediaType.APPLICATION_JSON))
